...
<%!
Connection con_postgres, con_tlapaleria;
String sql_bd = "create database tlapaleria";

String sql_tabla_usuario = "create table usuario (id serial primary key, nombre character varying  (30) not null, edad integer not null, domicilio character varying(100) not null, telefono Character varying (10) not null)";
String sql_tabla_vuelo =  "create table vuelo (numero_vuelo integer primary key, origen character varying  (20) not null, destino character varying (20)  not null, hora_salida time with  time zone not null, avion Character varying (10) not null)";
 ...
 String url2 ="jdbc:postgresql://localhost:1025/tlapaleria";
Statement crear_bd, crear_tablas;
%>

<center>
	<h2 style="color:blue;">creacion de bd tlapaleria  y dos tablas </h2>
	<%
	try{
  ...
  con_tlapaleria = DriverManager.getConnection(url2, user, password);
  crear_tablas = con_tlapaleria.createStatement();
  crear_tablas.execute(sql_tabla_usuario);
