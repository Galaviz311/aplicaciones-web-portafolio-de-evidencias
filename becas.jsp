...
<%!
String  eliminar_bd = "drop database becas";
Connection postgres = null;
Statement borrar;
%>

<center>  
<h2 style="color: purple;"> Eliminación de la base de datos becas</h2>
...
%>
<h3 style="color: green;">se elimino la base de datos becas</h3>
<%
}catch(Exception e){
%>
